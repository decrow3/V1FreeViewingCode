...
% 
% 
% riseRec=find(diff(imecSync)>0);
% riseSent=find(diff(imecSent)>40);
...
% save(['/home/huklab/Documents/SpikeSorting/Output/2023-06-08/' 'Rocky-0608_g0_t0.nidq' 'dp_ev_ts.mat'],'Event')
% 
% close all
% clear Tout NiDaQout
%%
...
figure(1); clf
plot.raster(ptbst, ptbsw(:,6), 1, 'Color', 'r');
%%
...
%% Retry gave '-1686257209.144741058349609'
w=[1 1686257209.14474];
@(t)(t-w(2))/w(1)
myfun=@(t)(t-w(2))/w(1);
%% check
x1=0; x2=11400;
