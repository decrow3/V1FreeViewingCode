...
%% 
ephysPath='/mnt/NPX/Rocky/20231027/Rocky20231027_V1V2_g0';
ephysPrefix='Rocky20231027_V1V2_g0';
...
%   this final clock can be replaced with some other output hardware 
 ...
 %timingfilename='/mnt/NPX/Rocky/20231027/Rocky20231027_V2_g0/Rocky20231027_V2_g0_t0.nidq.bin';
...
%%
%  save('/home/huklab/Documents/SpikeSorting/Output/2023-10-27/Rocky20231027_V2_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync')
% clear Tout
 %load('/home/huklab/Documents/SpikeSorting/Output/2023-10-27/Rocky20231027_V2_g0_t0.nidq_imecAp.mat')
...
save(['/home/huklab/Documents/SpikeSorting/Output/2023-10-27/' 'Rocky20231027_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
%load(['/home/huklab/Documents/SpikeSorting/Output/2023-10-27/' 'Rocky20231027_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
StimPath='/mnt/NPX/Rocky/20231027/Rocky 2023-10-27/';
...
subplot(212)
plot(ptbt_,ptbwords,'.')
xlim([1698442000 1698460000]); ylim([0 64]);
...
ptbt=ptbt_(ptbt_>1698442000);
ptbwords=ptbwords(ptbt_>1698442000);
...
% Load facecall data
dataPath1 ='/mnt/NPX/Rocky/20231027/Rocky 2023-10-27/';
...
[Exp, fig] = io.import_eye_position(Exp, dataPath1, 'fid', fid, 'zero_mean', true, 'normalize', true);
%[Exp, fig] = io.import_eye_position_ddpi10272023(Exp, dataPath1, 'fid', fid, 'zero_mean', true, 'normalize', true);
...
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-10-27/';
...
%% Second probe
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-10-27-imec1/';
...
%% Retry with handful
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-10-27/Retry';
Exp.osp = load(fullfile(dataPath, 'spkilo.mat'));
Exp.osp.st = Exp.osp.st;
Exp.osp.st(Exp.osp.st<0)=0;
% move zero to the end
...
Exp=load('/home/huklab/Documents/NPX_pilot/Rock20231027_V1V2_onlinedpi.mat');
resync=load('/home/huklab/Documents/NPX_pilot/Rocky20231027_resync.mat');
Exp.ptb2Ephys=resync.fun;
Exp.FileTag='Rocky20231027_V1V2_resorted';
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-10-27_FullyResorted/Rocky_2023-10-27-prb1/';
Exp.osp = load(fullfile(dataPath, 'spkilo.mat'));
Exp.osp.st = Exp.osp.st;
Exp.osp.st(Exp.osp.st<0)=0;
% move zero to the end
...
%% Second probe
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-10-27_FullyResorted/Rocky_2023-10-27-prb2/';
Exp.osp2 = load(fullfile(dataPath, 'spkilo.mat'));
Exp.osp2.st = Exp.osp2.st;
Exp.osp2.st(Exp.osp2.st<0)=0;
% move zero to the end
...
saveas(figure(fig),['/home/huklab/Documents/NPX_pilot/Rocky20231027_V2V1_imec0_imec1_dotRFs/Rocky20231027_V2V1_imec0_imec1_dotRFs_' num2str(nperfig*(fig-1)+1) '_' num2str(nperfig*fig) '.pdf'])
end
...
staticfixtrials=find(cellfun(@(x) strcmp(x.PR.name,'BackImages'),Exp.D));
trial_start_times=cellfun(@(x) x.STARTCLOCKTIME,Exp.D);
trial_end_times=cellfun(@(x) x.ENDCLOCKTIME,Exp.D);
