...
%% 
ephysPath='/mnt/NPX/Rocky/20240414/Rocky20240414_V1V2_g0';
%These were unfortunately mislabeled
ephysPrefix='Rocky20240414_V1V2_g0';
...
%   this final clock can be replaced with some other output hardware 
 ...
 %timingfilename='/mnt/NPX/Rocky/20240414/Rocky20240414_V2_g0/Rocky20240414_V2_g0_t0.nidq.bin';
...
%%
 save('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240414/Rocky20240414_V2_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync','Event')
% clear Tout
 %load('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240414/Rocky20240414_V2_g0_t0.nidq_imecAp.mat')
...
save(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240414/' 'Rocky20240414_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
%load(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240414/' 'Rocky20240414_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
StimPath='/mnt/NPX/Rocky/20240414/Rocky20240414/';
...
% Load facecall data
% dataPath1 ='/mnt/NPX/Rocky/20240414/Rocky 2024-04-14/facecal';
...
C.cmat= [1.0160    1.0035   -2.9989   -0.2157    0.3844];
...
cmat=[ 5.8750    6.3559   -1.1063  -45.3766  -99.0466];
C.cmat=cmat
%%
clear C
C = calibGUI(Exp,'use_smo',0);
C.cmat=[5.7756    6.3420   -2.9963  -37.6289  -86.9902]
...
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/Rocky-2014-04-14-imec0-redo';
...
%% Second probe
dataPath = '/home/huklab/Documents/SpikeSorting/Output/Rocky-2024-04-14-imec1';
...
% %% Retry with handful
% %% Load spikes
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2024-04-14/Retry';
% Exp.osp = load(fullfile(dataPath, 'spkilo.mat'));
% Exp.osp.st = Exp.osp.st;
% Exp.osp.st(Exp.osp.st<0)=0;
% % move zero to the end
...
% 
% Exp=load('/home/huklab/Documents/NPX_pilot/Rock20240414_V1V2_onlinedpi.mat');
% resync=load('/home/huklab/Documents/NPX_pilot/Rocky20240414_resync.mat');
% Exp.ptb2Ephys=resync.fun;
% Exp.FileTag='Rocky20240414_V1V2_resorted';
% %% Load spikes
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2024-04-14_FullyResorted/Rocky_2024-04-14-prb1/';
% Exp.osp = load(fullfile(dataPath, 'spkilo.mat'));
% Exp.osp.st = Exp.osp.st;
% Exp.osp.st(Exp.osp.st<0)=0;
% % move zero to the end
...
% 
% %% Second probe
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2024-04-14_FullyResorted/Rocky_2024-04-14-prb2/';
% Exp.osp2 = load(fullfile(dataPath, 'spkilo.mat'));
% Exp.osp2.st = Exp.osp2.st;
% Exp.osp2.st(Exp.osp2.st<0)=0;
% % move zero to the end
...
for fig=1:nfigs
    figure(fig)
    set(gcf,'Position',[0 0 1080 1080])
saveas(figure(fig),['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240414/Rocky20240414_V2V1_dotRFs/Rocky20240414_V2V1_dotRFs_' num2str(nperfig*(fig-1)+1) '_' num2str(nperfig*fig) '.pdf'])
end
