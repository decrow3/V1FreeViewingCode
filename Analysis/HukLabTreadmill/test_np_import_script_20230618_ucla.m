...
timingfilename='/mnt/NPX/Rocky/20230618/Rocky-v1-0618_g0/Rocky-v1-0618_g0_t0.nidq.bin';
nchannels=4;
samples=[];
dataformat=[];
memorymap=1;
...
spikefilename='/mnt/NPX/Rocky/20230618/Rocky-v1-0618_g0/Rocky-v1-0618_g0_imec0/Rocky-v1-0618_g0_t0.imec0.ap.bin';
nchannels=385;
samples=[];
dataformat=[];
memorymap=1;
...
%%
%save('/home/huklab/Documents/SpikeSorting/Output/2023-06-18/Rocky-0618_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync')
load('/home/huklab/Documents/SpikeSorting/Output/2023-06-18/Rocky-0618_g0_t0.nidq_imecAp.mat')
%%
...
save(['/home/huklab/Documents/SpikeSorting/Output/2023-06-18/' 'Rocky-0618_g0_t0_2.nidq' 'dp_ev_ts.mat'],'Event')
% 
% close all
% clear Tout NiDaQout
%%

%/mnt/NPX/Rocky/20230618/Rocky-v1-0618_g0/Rocky-v1-0618_g0_t0.nidq.bin'
load(['/home/huklab/Documents/SpikeSorting/Output/2023-06-18/' 'Rocky-0618_g0_t0_2.nidq' 'dp_ev_ts.mat'],'Event')
...
StimPath='/mnt/NPX/Rocky/20230618/Rocky 2023-06-18/';
...
%% Run Fixbiter.m
toffset=-1687134402.981395244598389;
...
%%
%C.cmat=[1.0188    1.0343   -8.9976   -2.9057    2.2648];
...
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-06-18/';
...
%% plot subset
subset = [526 527 529 530 531 541 544 579 580 581 592 593 597 600 612 614 628 633 634 659 661 678 694 697 710 724 742 ...
   754 756 758 757 758 760 763 783 806 808 812 816 835 872 892 898 900 1048];
nsub = numel(subset);
