...
opts.use_tf_tents = true;
opts.tf_ctrs = [0.5 2 8];
opts.sf_ctrs = [0.5 2 8];
opts.run_thresh = 1;
[X, opts] = build_design_matrix_sf_tf(Stim, opts);
...
excludeParams = { {'Stim', 'Stim Onset'}, {'Is Running', 'Saccade'}, {'Is Running'}, {'Saccade'}, {}, {'Stim','Stim Onset','Is Running','Saccade'} };
alwaysExclude = {'Stim R', 'Stim S', 'Running', 'Is Pupil'};

Rpred = struct();

models2fit = modelNames;%{'stim', 'drift'};
