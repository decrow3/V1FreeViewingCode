...
%% 
ephysPath='/mnt/NPX/Rocky/20240229/Rocky20240229_V1V2_g0';
%These were unfortunately mislabeled
ephysPrefix='Rocky20231209_V1V2_g0';
...
%   this final clock can be replaced with some other output hardware 
 ...
 %timingfilename='/mnt/NPX/Rocky/20240229/Rocky20240229_V2_g0/Rocky20240229_V2_g0_t0.nidq.bin';
...
%%
 save('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240229/Rocky20240229_V2_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync','Event')
% clear Tout
 %load('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240229/Rocky20240229_V2_g0_t0.nidq_imecAp.mat')
...
save(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240229/' 'Rocky20240229_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
%load(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240229/' 'Rocky20240229_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
StimPath='/mnt/NPX/Rocky/20240229/Rocky 2024-02-29/';
...
% Load facecall data
% dataPath1 ='/mnt/NPX/Rocky/20240229/Rocky 2024-02-29/facecal';
...
C.cmat= [ 1.1910    1.1704   -2.9989   -4.3257  -0.5456];
...
cmat=[ 10.9745   10.4352   -5.0501  335.1608 -225.4942];
C.cmat=cmat
%%
eyePos =C.get_eyepos();
...
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/Rocky-2024-02-29-imec0';
...
%% Second probe
dataPath = '/home/huklab/Documents/SpikeSorting/Output/Rocky-2024-02-29-imec1';
...
% %% Retry with handful
% %% Load spikes
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2024-02-29/Retry';
% Exp.osp = load(fullfile(dataPath, 'spkilo.mat'));
% Exp.osp.st = Exp.osp.st;
% Exp.osp.st(Exp.osp.st<0)=0;
% % move zero to the end
...
% 
% Exp=load('/home/huklab/Documents/NPX_pilot/Rock20240229_V1V2_onlinedpi.mat');
% resync=load('/home/huklab/Documents/NPX_pilot/Rocky20240229_resync.mat');
% Exp.ptb2Ephys=resync.fun;
% Exp.FileTag='Rocky20240229_V1V2_resorted';
% %% Load spikes
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2024-02-29_FullyResorted/Rocky_2024-02-29-prb1/';
% Exp.osp = load(fullfile(dataPath, 'spkilo.mat'));
% Exp.osp.st = Exp.osp.st;
% Exp.osp.st(Exp.osp.st<0)=0;
% % move zero to the end
...
% 
% %% Second probe
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2024-02-29_FullyResorted/Rocky_2024-02-29-prb2/';
% Exp.osp2 = load(fullfile(dataPath, 'spkilo.mat'));
% Exp.osp2.st = Exp.osp2.st;
% Exp.osp2.st(Exp.osp2.st<0)=0;
% % move zero to the end
...
for fig=1:nfigs
    figure(fig)
    set(gcf,'Position',[0 0 1080 1080])
saveas(figure(fig),['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240229/Rocky20240229_V2V1_dotRFs/Rocky20240229_V2V1_dotRFs_' num2str(nperfig*(fig-1)+1) '_' num2str(nperfig*fig) '.pdf'])
end
