...
% timingfilename='/mnt/NPX/Rocky/20230601/Rocky-0601_g0/Rocky-0601_g0_t0.nidq.bin';
% nchannels=4;
% samples=[];
% dataformat=[];
% memorymap=1;
...
% 
% 
% Event.samplenumber=find(sum(datapixx,2));
% Event.ts=(Event.samplenumber)/30003.000300;% from nidaq metafile
% Event.signal=datapixx(Event.samplenumber,:);
% 
% imecSync=ttl(:,8)=='1';
% %Received signals from imec card for syncing 
% 
% 
% spikefilename='/mnt/NPX/Rocky/20230601/Rocky-0601_g0/Rocky-0601_g0_imec0/Rocky-0601_g0_t0.imec0.ap.bin';
% nchannels=385;
% samples=[];
% dataformat=[];
% memorymap=1;
...
% save(['/home/huklab/Documents/SpikeSorting/Output/2022-07-01/' 'Rocky-0601_g0_t0.nidq' 'dp_ev_ts.mat'],'Event')
% 
% close all
% clear Tout NiDaQout
%%
load(['/home/huklab/Documents/SpikeSorting/Output/2023-06-01/' 'Rocky-0601_g0_t0.nidq' 'dp_ev_ts.mat'],'Event')
...
StimPath='/mnt/NPX/Rocky/20230601/Stimuli/';
...
% Load facecall data
dataPath1 = [StimPath 'FaceCal - not recorded'];
...
cmat=[0.0061   -0.0035    0.0008    0.0004   -0.0002];
%%
cmat=[0.0029   -0.0038    0.0008    0.0004   -0.0002];
%%
...
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-06-01/';
