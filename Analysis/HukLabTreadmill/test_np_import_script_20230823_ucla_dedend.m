...
% timingfilename='/mnt/NPX/Rocky/20230823/Rocky_set0V1medial_g0/Rocky_set0V1medial_g0_t0.nidq.bin';
% nchannels=4;
% samples=[];
% dataformat=[];
% memorymap=1;
...
% Event.ts=(Event.samplenumber)/30002.845833;% from nidaq metafile
...
% spikefilename='/mnt/NPX/Rocky/20230823/Rocky_set0V1medial_g0/Rocky_set0V1medial_g0_imec0/Rocky_set0V1medial_g0_t0.imec0.ap.bin';
% nchannels=385;
% samples=[];
% dataformat=[];
% memorymap=1;
...
% %%
% %save('/home/huklab/Documents/SpikeSorting/Output/2023-08-23/Rocky-0823_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync')
% %load('/home/huklab/Documents/SpikeSorting/Output/2023-08-23/Rocky-0823_g0_t0.nidq_imecAp.mat')
% %%
% 
...
% Event.PD_ts=Event.PhDiodeClosestAPSamples/30000.074166666665; % from AP metafile

%% Events recorded on NiDaq are now in terms of seconds from start of NPX
%recording

 %save(['/home/huklab/Documents/SpikeSorting/Output/2023-08-23/' 'Rocky-0823_g0_t0.nidq' 'dp_ev_ts2.mat'],'Event')
% 
% close all
% clear Tout NiDaQout
%%
%/mnt/NPX/Rocky/20230823/Rocky_set0V1medial_g0/Rocky_set0V1medial_g0_t0.nidq.bin'
load(['/home/huklab/Documents/SpikeSorting/Output/2023-08-23/' 'Rocky-0823_g0_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
%% Run Fixbiter.m
toffset=-1692830932.691995382308960;
...
cmat=[0.2253    0.2129   -0.9986  -31.3865   16.2046];
C.cmat=cmat;
%%
...
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-08-23/';
