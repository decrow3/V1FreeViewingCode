...
'/media/declan/Extreme Pro/NPData/ephys/Brie/2022-06-30/2022-06-30_15-59-58/Neuropix-PXI-101.0/kilosort3/'
...
dataPath = fullfile(HUKDATA, 'BrieMTsession','20220630');
figDir = fullfile(HUKDATA, 'BrieMTsession','20220630','out');%'~/Google Drive/HuklabTreadmill/imported_sessions_qa/gru_20220516/';
%%
dataPath = '/media/declan/Extreme Pro/NPData/ephys/Brie/2022-06-30/2022-06-30_15-59-58/events/Rhythm_FPGA-102.0/TTL_1/';
...
dataPath= '/media/declan/Extreme Pro/NPData/behav/20220630/';
...
save('b202200630_quicksaveln198.mat','-v7.3')


%%
%% Load facecall data without sync
dataPath1 = '/media/declan/Extreme Pro/NPData/behav/20220630/Facecal/';
...
plot(Exp.vpx.smo(:,2))
%%
save('b20220630_quicksaveln393.mat','-v7.3')
%%
% %%
...
%% load spikes
dataPath = '/home/declan/data/BrieMTsession/20220630/ephys/2022-06-30_17-31-35/Neuropix-PXI-101.0/Kilosort/';
...
timingloc='/home/declan/data/BrieMTsession/20220630/ephys/2022-06-30_17-31-35/Neuropix-PXI-101.0/'
...
%%
save('b20220630_quicksaveln825.mat','-v7.3')
...
%plot.fixfigure(gcf, 12, [8 11])
%%
figDir='/home/declan/data/BrieMTsession/20220630/out/';
...
Exp.FileTag = 'brie/b20220630.mat'
