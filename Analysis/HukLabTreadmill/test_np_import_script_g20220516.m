...
dataPath = fullfile(HUKDATASHARE, 'gru', 'g20220516');
figDir = '~/Google Drive/HuklabTreadmill/imported_sessions_qa/gru_20220516/';
%%
...
save('g20220516_quicksaveln198.mat','-v7.3')


%%
%% Load facecall data without sync
dataPath1 = 'H:\.shortcut-targets-by-id\1te-Fna8YGaocWpO9rfNSoLtLeuzSNCPq\HuklabTreadmill\gru\g20220516\FaceCal';
...
plot(Exp.vpx.smo(:,2))
%%
save('g20220516_quicksaveln393.mat','-v7.3')
%%
% %%
