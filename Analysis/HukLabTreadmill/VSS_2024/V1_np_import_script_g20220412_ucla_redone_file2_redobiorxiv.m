...
dataPath=('/home/huklab/Documents/SpikeSorting/Combining/Gru_2022-04-12/kilosort4/');
...
keepRF(cc)=peakRF>(avRF+2*std(RF(:)));
...
%%
save('g20220412_quicksaveln825_file3re_12_8_re_bio.mat','-v7.3')
...
figDir=dataPath;
saveas(gcf, fullfile(dataPath, 'grating_sess_birdseye2_bio.pdf'))
...
Exp.FileTag = 'g20220412re3_bio.mat'
