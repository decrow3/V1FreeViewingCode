...
%% 
ephysPath='/mnt/NPX/Rocky/20231209/Rocky20231209_V1V2_g0';
...
%   this final clock can be replaced with some other output hardware 
 ...
 %timingfilename='/mnt/NPX/Rocky/20231209/Rocky20231209_V2_g0/Rocky20231209_V2_g0_t0.nidq.bin';
...
%%
 save('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20231209/Rocky20231209_V2_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync')
% clear Tout
 %load('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20231209/Rocky20231209_V2_g0_t0.nidq_imecAp.mat')
...
save(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20231209/' 'Rocky20231209_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
%load(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20231209/' 'Rocky20231209_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
StimPath='/mnt/NPX/Rocky/20231209/Rocky 2023-12-09/';
...
% Load facecall data
dataPath1 ='/mnt/NPX/Rocky/20231209/Rocky 2023-12-09/';
...
%% Load spikes
dataPath = '/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20231209/';
Exp.osp = load(fullfile(dataPath, 'spkilo_imec0.mat'));
...
%% Second probe
dataPath = '/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20231209/';
Exp.osp2 = load(fullfile(dataPath, 'spkilo_imec1.mat'));
...
% %% Retry with handful
% %% Load spikes
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-12-09/Retry';
...
% 
% Exp=load('/home/huklab/Documents/NPX_pilot/Rock20231209_V1V2_onlinedpi.mat');
% resync=load('/home/huklab/Documents/NPX_pilot/Rocky20231209_resync.mat');
% Exp.ptb2Ephys=resync.fun;
% Exp.FileTag='Rocky20231209_V1V2_resorted';
% %% Load spikes
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-12-09_FullyResorted/Rocky_2023-12-09-prb1/';
% Exp.osp = load(fullfile(dataPath, 'spkilo.mat'));
% Exp.osp.st = Exp.osp.st;
% Exp.osp.st(Exp.osp.st<0)=0;
% % move zero to the end
...
% 
% %% Second probe
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-12-09_FullyResorted/Rocky_2023-12-09-prb2/';
...
for fig=1:nfigs
    figure(fig)
    set(gcf,'Position',[0 0 1080 1080])
saveas(figure(fig),['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20231209/Rocky20231209_V2V1_dotRFs/Rocky20231209_V2V1_dotRFs_' num2str(nperfig*(fig-1)+1) '_' num2str(nperfig*fig) '.pdf'])
end
