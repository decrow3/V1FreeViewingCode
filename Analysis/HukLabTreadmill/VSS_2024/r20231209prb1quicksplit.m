...
% Exp.FileTag = 'brie/r20231209_probe1.mat';
% Exp=load(fullfile(HUKDATA, Exp.FileTag));
Exp=load('/home/huklab/Documents/NPX_pilot/Rock20231209_V1V2_probe1.mat');
...
%% V1foveal
Exp=Exp0;
fovbool=((Exp.osp.clusterDepths>3400));
...
Exp.FileTag = 'brie/r20231209_probe1_fov.mat';
save('/media/huklab/Data/NPX/HuklabTreadmill/VSS/rocky_20231209_probe1_fov.mat', '-v7.3', '-struct', 'Exp')

%% V1calc shallow

Exp=Exp0;
calcbool=((Exp.osp.clusterDepths<3400));
...
Exp.FileTag = 'brie/r20231209_probe1_calc1.mat';
save('/media/huklab/Data/NPX/HuklabTreadmill/VSS/rocky_20231209_probe1_calc1.mat', '-v7.3', '-struct', 'Exp')
...
% Exp.spikeIds = Exp.osp.clu;
% Exp.spikeTimes = Exp.osp.st;
% Exp.FileTag = 'brie/r20231209_probe1_calc2.mat';
% save('/media/huklab/Data/NPX/HuklabTreadmill/VSS/rocky_20231209_probe1_calc2.mat', '-v7.3', '-struct', 'Exp')
% 
% 
% 
% %% V?fovealdeep
...
% Exp.spikeIds = Exp.osp.clu;
% Exp.spikeTimes = Exp.osp.st;
% Exp.FileTag = 'brie/r20231209_probe1_fov2.mat';
% save('/media/huklab/Data/NPX/HuklabTreadmill/VSS/rocky_20231209_probe1_fov2.mat', '-v7.3', '-struct', 'Exp')
