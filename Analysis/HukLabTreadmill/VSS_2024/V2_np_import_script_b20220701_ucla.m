...
dataPath = fullfile(HUKDATA, 'BrieV2session','20220701');
figDir = fullfile(HUKDATA, 'BrieV2session','20220701','out');%'~

%%
% File combiner ran and sorted, files saved to:
dataPath= '/media/huklab/Data/NPX/Brie/2022-07-01/Combined/';
dataPath= '/mnt/NPX/Brie/2022-07-01/Combined/Probe1/';
...
stimPath= '/media/huklab/Data/NPX/Brie/2022-07-01/20220701';
stimPath= '/mnt/NPX/Brie/StimFiles/20220701/';
...
potential_matches= potential_matches(5:end-5);
...
save('b20220701_V2_quicksaveln200.mat','-v7.3')


%%
%% Load facecall data only
dataPath1 = [dataPath '/Facecal/'];
Exp1 = io.basic_marmoview_import(dataPath1);
fid = 1;
%% Grab Eye positions from facecal set 
[Exp1, fig] = io.import_eye_position(Exp1, dataPath1, 'fid', fid, 'zero_mean', true, 'normalize', true);
...
calib0=load('/home/huklab/Documents/NPX_pilot/MarmoV5/SupportData/MarmoViewLastCalib.mat')
%This doesn't work
...
%  C.cmat=[0.0061    -0.00690   -0.0020    0.080   -0.0550];
 ...
 %C.cmat=[0.0066    0.0075   -0.0008    0.0768   -0.0720];
 C.cmat=[0.0068    -0.00680   -0.0020    0.080   -0.0750];
...
%%
save('b20220701_quicksaveln500.mat','-v7.3')
%%
% %%
...
%% load spikes
% dataPath = '/home/declan/data/BrieMTsession/20220701/ephys/2022-07-01_17-31-35/Neuropix-PXI-101.0/Kilosort/';
%dataPath = '/home/declan/data/BrieMTsession/20220701/ephys/2022-07-01_12-44-58/experiment1/continuous/Neuropix-PXI-101.0/kilosort/';
dataPath= '/home/huklab/Documents/SpikeSorting/Output/2022-07-01/';
...
%%
% timingloc='/home/declan/data/BrieMTsession/20220701/ephys/2022-08-09_12-44-58/experiment1/continuous/Neuropix-PXI-101.0/';
% NPXtimestamps          = readNPY([timingloc 'timestamps.npy']);
dataPath= '/mnt/NPX/Brie/2022-07-01/Combined/';
...
%% Check timing!
figure(1); clf
plot.raster(Exp.osp.st0+offset, Exp.osp.clu0, 1); hold on; %+offset_Xcorr not here?
plot(t,strobes,'o')
...
goodclusters        = labelledClusters(labels==2|labels==1);

sum(labels==2|labels==1)
...
% timingloc='/home/declan/data/BrieMTsession/20220701/ephys/2022-08-09_17-31-35/Neuropix-PXI-101.0/'
...
%%
save('b20220701_quicksaveln825.mat','-v7.3')
...
%plot.fixfigure(gcf, 12, [8 11])
%%
figDir='/home/declan/data/BrieV2session/20220701/out/';
...
Exp.FileTag = 'brie/b20220701.mat'
