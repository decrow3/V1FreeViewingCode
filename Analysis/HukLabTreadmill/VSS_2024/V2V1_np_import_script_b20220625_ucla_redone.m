...
%%
load('/home/huklab/Documents/SpikeSorting/Output/2022-06-25/rez.mat')
tt=max(rez.st3(:,1))
...
%by depth
[~,Dpsgood]=(sort(Exp.osp.clusterDepths(goodunits)));
[~,Dpsallind]=(sort(Exp.osp.clusterDepths(goodunits)));
...
Exp.FileTag = 'brie_b20220625_prb1.mat'
