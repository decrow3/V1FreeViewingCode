...
%% 
ephysPath='/mnt/NPX/Rocky/20230907/Rocky20230907_V2_g0';
ephysPrefix='Rocky20230907_V2_g0';
...
%   this final clock can be replaced with some other output hardware 
 ...
 %timingfilename='/mnt/NPX/Rocky/20230907/Rocky20230907_V2_g0/Rocky20230907_V2_g0_t0.nidq.bin';
...
%%
%  save('/home/huklab/Documents/SpikeSorting/Output/2023-09-07/Rocky20230907_V2_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync')
% clear Tout
 load('/mnt/NPX/Rocky/20230907/Sorted/Rocky20230907_V2_g0_t0.nidq_imecAp.mat')
...
%save(['/home/huklab/Documents/SpikeSorting/Output/2023-09-07/' 'Rocky20230907_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
load(['/mnt/NPX/Rocky/20230907/Sorted/' 'Rocky20230907_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
StimPath='/mnt/NPX/Rocky/20230907/Rocky 2023-09-07/';
...
switchbits(:,5)=Recbits(:,3); %%!!!!
switchbits(:,4)=Recbits(:,2); %%!!!!
switchbits(:,3)=Recbits(:,5); %%%!!!
switchbits(:,2)=Recbits(:,4); %%!!!!
...
ptbt=ptbt_(ptbt_>1694132500);
ptbwords=ptbwords(ptbt_>1694132500);
...
%%
hold off
plot(Event.fallPD_ts,.95*ones(1,length(Event.fallPD_ts)),'.')
hold on
plot(Event.risePD_ts,1.05*ones(1,length(Event.risePD_ts)),'.')
plot(PD_PTBinAPtimes,ones(1,length(PD_PTBinAPtimes)),'.')
xlim([5000 5500]);ylim([0.8 1.2])
...
% Load facecall data
dataPath1 ='/mnt/NPX/Rocky/20230907/Rocky 2023-09-07/';
...
cmat=[0.2153    0.2151   -3.0000  -31.5932   16.8119]; % online track
...
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/20230907-redo/';
...
if sum(cellfun(@(x) strcmp(x.PR.name,'FixedProceduralNoise'),Exp.D))
    ...
    [Xstim, RobsSpace, opts] = io.preprocess_staticspatialmapping_data(Exp_subset, ...
        'ROI', BIGROI*Exp.S.pixPerDeg, 'binSize', binSize*Exp.S.pixPerDeg, ...
        'eyePosExclusion', 2e3, ...
        'eyePos',Exp.vpx.smo(:,2:3), 'frate', Frate, 'fastBinning', true);% Exp.vpx.smo(:,2:3)
