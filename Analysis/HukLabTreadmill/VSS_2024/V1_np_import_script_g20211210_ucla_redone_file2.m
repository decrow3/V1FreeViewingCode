...
%%
load('/home/huklab/Documents/SpikeSorting/Output/Gru/20211210-file2/rez.mat')

tt=max(rez.st3(:,1))
tbatch=tt/rez.ops.Nbatch
dshifttimes=(1:tbatch:tt);
dshift=rez.dshift;
save('/home/huklab/Documents/SpikeSorting/Output/Gru/20211210-file2/shifts.mat','dshift','dshifttimes')
subplot(8,1,[1:7])
...
dataPath = '/home/huklab/Documents/SpikeSorting/Output/Gru/20211210-file2/';
figDir = dataPath;%fullfile(HUKDATA, 'Grusessionf2','20211210','out');%'~

%%
% % File combiner ran and sorted, files saved to:
% dataPath= '/home/huklab/Documents/SpikeSorting/Output/2021-12-10-file3re_12_8/';
...
stimPath= '/mnt/NPX/Gru/20211210/mv5_expt_files/';
Exp = io.basic_marmoview_import(stimPath);%, tstruct
...
%%
save('g20211210_quicksaveln500_re_f3_.mat','-v7.3')
%%
% %%
...
%% load spikes
% dataPath = '/home/declan/data/BrieMTsession/20211210/ephys/2021-12-10_17-31-35/Neuropix-PXI-101.0/Kilosort/';
%dataPath = '/home/declan/data/BrieMTsession/20211210/ephys/2021-12-10_12-44-58/experiment1/continuous/Neuropix-PXI-101.0/kilosort/';
...
%%
% timingloc='/home/declan/data/BrieMTsession/20211210/ephys/2021-12-10_12-44-58/experiment1/continuous/Neuropix-PXI-101.0/';
...
% timingloc='/home/declan/data/BrieMTsession/20211210/ephys/2021-12-10_17-31-35/Neuropix-PXI-101.0/'
...
%%
save('g20211210_quicksaveln825_file3re_12_8_re.mat','-v7.3')
...
%plot.fixfigure(gcf, 12, [8 11])
%%
figDir='/home/declan/data/BrieMTsession/20211210/out/';
figDir=dataPath;
