...
Exp.FileTag = 'VSS/brie_b20220625_prb2.mat';
...
%% V1foveal
Exp=Exp0;
fovbool=((Exp.osp.clusterDepths>5300));
...
Exp.FileTag = 'brie/b20220625_probe2_fov.mat';
save('/media/huklab/Data/NPX/HuklabTreadmill/VSS/brie_20220625_probe2_fov.mat', '-v7.3', '-struct', 'Exp')
