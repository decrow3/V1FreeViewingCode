...
dataPath= '/home/huklab/Documents/SpikeSorting/Output/Brie_2022-07-01/';
...
%%
%save('b20220701_quicksaveln500_re.mat','-v7.3')
%%
% %%
...
dataPath = '/home/huklab/Documents/SpikeSorting/Output/Brie-2022-07-01-V1-Probe2-Sorted/';
...
% subset = [509, 516, 764,766,768,780,782,785,1123,1128, 1139];
...
%     I = std(I);
    ...
    title(Exp.osp.clusterDepths(ccid(cc)))
    grid on
end
...
%% V1calc
V1calcsub=Exp.osp.cids(Exp.osp.clusterDepths>1000);
Exp=Exp0;
