...
dataPath = fullfile(HUKDATASHARE, 'gru', 'g20220323');
figDir = '~/Google Drive/HuklabTreadmill/imported_sessions_qa/gru_20220323/';
%%
...
dataPath = 'H:\.shortcut-targets-by-id\1te-Fna8YGaocWpO9rfNSoLtLeuzSNCPq\HuklabTreadmill\gru\g20220423'; %~/Google Drive/HuklabTreadmill/gru/g20210521/';
fid = 1;
...
dataPath1 = 'H:\.shortcut-targets-by-id\1te-Fna8YGaocWpO9rfNSoLtLeuzSNCPq\HuklabTreadmill\gru\g20220323\FaceCal\';
...
%%
%Worked???
% C.cmat= 1.0212    1.1238    0.0069    0.1584    1.1821
%%
...
%  axis equal;xlim([-12 12]);ylim([-12 12]);
 ...
 %
 figure(1);hold off
 plot(eyePos(1:150:end,1),eyePos(1:150:end,2),'r.')
...
eyePos0 =get_eyepos(C);%Exp0.vpx.smo(:,2:3);
...
eyePos1 = (Exp1.vpx.smo(:,2:3) - cmat(4:5))*Ainv;
...
eyePos = (Exp.vpx.smo(:,2:3) - cmat(4:5))*Ainv;
...
plot(Exp.vpx.smo(:,2))
%%
save('g20220323_quicksaveln393.mat','-v7.3')
%%
% %%
...
%% load spikes
dataPath = fullfile(HUKDATASHARE, 'gru', 'g20220323');
Exp.osp = load(fullfile(dataPath, 'spkilo_re-sorted.mat'));
