...
%% 
ephysPath='/mnt/NPX/Rocky/20231004/Rocky20231004_V2_restart_g0';
ephysPrefix='Rocky20231004_V2_restart_g0';
...
%   this final clock can be replaced with some other output hardware 
 ...
 %timingfilename='/mnt/NPX/Rocky/20231004/Rocky20231004_V2_g0/Rocky20231004_V2_g0_t0.nidq.bin';
...
%%
dig1=ttl(:,9-1)=='1'; %imec
dig2=ttl(:,9-2)=='1'; %datapixx sync // digital photodiode
dig3=ttl(:,9-3)=='1'; %datapixx 1 smallest bit //arduino  1
dig4=ttl(:,9-4)=='1'; %datapixx 2 //arduino  2
dig5=ttl(:,9-5)=='1'; %datapixx 3
dig6=ttl(:,9-6)=='1'; %datapixx 4
dig7=ttl(:,9-7)=='1'; %datapixx 5
dig8=ttl(:,9-8)=='1'; %datapixx 6
...
save('/home/huklab/Documents/SpikeSorting/Output/2023-10-04/Rocky20231004_V2_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync','risePD','fallPD')
% clear Tout
 %load('/home/huklab/Documents/SpikeSorting/Output/2023-10-04/Rocky20231004_V2_g0_t0.nidq_imecAp.mat')
...
save(['/home/huklab/Documents/SpikeSorting/Output/2023-10-04/' 'Rocky20231004_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
%load(['/home/huklab/Documents/SpikeSorting/Output/2023-10-04/' 'Rocky20231004_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
RecStrobes=any(Event.signal(:,1:4)'=='1')';
...
% zdata=load('/mnt/NPX/Rocky/20231004/Rocky 2023-10-04/FaceCal_Rocky_210923_04.mat');
% S=zdata.S;
% D=cell(1,1);
...
StimPath='/mnt/NPX/Rocky/20231004/Rocky 2023-10-04/';
...
%% Stepping in to save lost bits
RecWords=bin2dec(Event.signal(strobeIdx,1:4));
sentbits=dec2bin(ptbwords);
ptbwords_=bin2dec(sentbits(:,1:4));
...
ptb_tstart=1696454600;
ptbt=ptbt_(ptbt_>ptb_tstart);
ptbwords=ptbwords_(ptbt_>ptb_tstart);
...
%% If happy lock it in!!!
Exp.ptb2Ephys = myfun;
% Exp.FileTag= 'Rock20231004_V2_nodpi';
% save(fullfile(Exp.FileTag), '-v7.3', '-struct', 'Exp')
...
%% 
% Exp=load('Rock20231004_V2_nodpi.mat')
...
sumwaves=cellfun( @(x) x.PR.noisetype==9 ,Exp.D(foragetrials));
...
%%
%% Load spikes
dataPath = '/home/huklab/Documents/SpikeSorting/Output/2023-10-04/';
...
% Load facecall data
dataPath1 ='/mnt/NPX/Rocky/20231004/Rocky 2023-10-04/';
