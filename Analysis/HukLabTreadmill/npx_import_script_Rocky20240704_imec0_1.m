...
%% 
ephysPath='/mnt/NPX/Rocky/20240704/Rocky20240704_V1V2_g0';
%These were unfortunately mislabeled
ephysPrefix='Rocky20240704_V1V2_g0';
...
%   this final clock can be replaced with some other output hardware 
 ...
 %timingfilename='/mnt/NPX/Rocky/20240704/Rocky20240704_V2_g0/Rocky20240704_V2_g0_t0.nidq.bin';
...
%%
if isempty(dir('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240704/'))
    mkdir('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240704/')
end
 save('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240704/Rocky20240704_V2_g0_t0.nidq_imecAp.mat','riseSent','riseRec','imecSent','imecSync','Event')
% clear Tout
 %load('/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240704/Rocky20240704_V2_g0_t0.nidq_imecAp.mat')
...
save(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240704/' 'Rocky20240704_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
%load(['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240704/' 'Rocky20240704_V2_t0.nidq' 'dp_ev_ts2.mat'],'Event')
...
StimPath='/home/huklab/Documents/SpikeSorting/Output/Rocky/20240704/Rocky 2024-07-04/';%/mnt/NPX/Rocky/20240704/Rocky20240704/';
...
% Load facecall data
% dataPath1 ='/mnt/NPX/Rocky/20240704/Rocky 2024-07-04/facecal';
...
C.cmat= [   0.9032    0.9533   -3.9989   -0.3957   0.4044];
...
%% Load spikes
% dataPath = '/home/huklab/Documents/SpikeSorting/Output/Rocky/20240704/imec0_probe1_v2';
dataPath = '/mnt/NPX/Rocky/20240704/catgt_Rocky20240704_V1V2_g0/Rocky20240704_V1V2_g0_imec0/kilosort4/';
...
%% Second probe
%dataPath = '/home/huklab/Documents/SpikeSorting/Output/Rocky/20240704-imec1';
dataPath = '/mnt/NPX/Rocky/20240704/catgt_Rocky20240704_V1V2_g0/Rocky20240704_V1V2_g0_imec1/kilosort4/';
...
% 
% Exp=load('/home/huklab/Documents/NPX_pilot/Rock20240704_V1V2_onlinedpi.mat');
% resync=load('/home/huklab/Documents/NPX_pilot/Rocky20240704_resync.mat');
% Exp.ptb2Ephys=resync.fun;
% Exp.FileTag='Rocky20240704_V1V2_resorted';
% %% Load spikes
...
for fig=1:nfigs
    figure(fig)
    set(gcf,'Position',[0 0 1080 1080])
saveas(figure(fig),['/home/huklab/Documents/NPX_pilot/Output/RockyV2V1_20240704/Rocky20240704_V2V1_dotRFs/Rocky20240704_V2V1_dotRFs_' num2str(nperfig*(fig-1)+1) '_' num2str(nperfig*fig) '.pdf'])
end
